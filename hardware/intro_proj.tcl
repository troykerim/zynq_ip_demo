...
#
# intro_proj.tcl: Tcl script for re-creating project 'intro_proj'
#
# Generated by Vivado on Tue Jun 10 20:15:22 PDT 2025
...
#
# 1. This project restoration tcl script (intro_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/troy/zynq_ip_demo/hardware/intro_proj/intro_proj.gen/sources_1/bd/zynq_system/hdl/zynq_system_wrapper.vhd"
#    "/home/troy/zynq_ip_demo/hardware/intro_proj/intro_proj.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/intro_proj/intro_proj.gen/sources_1/bd/zynq_system/hdl/zynq_system_wrapper.vhd"]"\
 "[file normalize "$origin_dir/intro_proj/intro_proj.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "intro_proj"
...
set script_file "intro_proj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/intro_proj"]"
...
set file "hdl/zynq_system_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zynq_sys_wrapper" -objects $obj
...
# Proc to create BD zynq_sys
proc cr_bd_zynq_sys { parentCell } {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-294,-349",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 2 -x 430 -y -150 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 2 -x 430 -y -130 -defaultsOSRD
...
preplace netloc processing_system7_0_DDR 1 1 1 NJ -150
preplace netloc processing_system7_0_FIXED_IO 1 1 1 NJ -130
levelinfo -pg 1 -10 210 430
pagesize -pg 1 -db -bbox -sgen -10 -210 550 200
"
}
...
# End of cr_bd_zynq_sys()
cr_bd_zynq_sys ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_sys.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_sys.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse zynq_sys.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/intro_proj/intro_proj.gen/sources_1/bd/zynq_sys/hdl/zynq_sys_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zynq_sys.bd] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/intro_proj.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp" -objects $obj
